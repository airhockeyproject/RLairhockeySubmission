...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/src/install/crane_x7"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crane_x7/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crane_x7/environment/path.sh"
